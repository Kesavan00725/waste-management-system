...
urlpatterns = [
    ...
    # ── Citizen Management (Admin) ─────────────────────────────────────
    path('citizens/', views.citizens_list, name='citizens_list'),
    path('citizens/export/', views.export_citizens_csv, name='export_citizens_csv'),

    # ── Citizen Panel ──────────────────────────────────────────────────
    path('citizen/', views.citizen_dashboard, name='citizen_dashboard'),
    path('citizen/complaints/', views.citizen_complaints, name='citizen_complaints'),
